// Vendored from react-bits (MIT) — DavidHDev/react-bits, src/ts-default/Backgrounds/ColorBends.
// Disable strict checks; the upstream component is loose about uniform-map indexing.
// @ts-nocheck
